...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css =
      ...
      ".dsct_wrap.dsct_show .dsct_pin{display:inline-flex}" +
...
"body[data-ds-dark-theme] .dsct_star.dsct_star_on,[data-theme='dark'] .dsct_star.dsct_star_on,.dark .dsct_star.dsct_star_on{color:#fbbf24;opacity:1}" + 
      ...
      ".dsct_dayrow{display:flex;align-items:center;gap:6px;width:100%;margin:6px 8px 4px 0;flex-shrink:0;user-select:none}" +
