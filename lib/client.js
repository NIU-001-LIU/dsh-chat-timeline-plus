...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css =
      ...
      /* 顶部筛选栏 */
      ".dsct_filter{padding:8px 12px 4px 12px;display:flex;justify-content:space-between;align-items:center;border-bottom:none;box-sizing:border-box}" +       ".dsct_filter{display:none}" +       ".dsct_wrap.dsct_show .dsct_filter{display:flex}" +  +
      "body[data-ds-dark-theme] .dsct_filter,[data-theme='dark'] .dsct_filter,.dark .dsct_filter{border-bottom:none}" +
      ...
      ".dsct_pin{display:none;align-items:center;padding:4px;cursor:pointer;color:rgba(0,0,0,.4);user-select:none}" +
      ".dsct_wrap.dsct_show .dsct_pin{display:inline-flex}" + ".dsct_wrap.dsct_show .dsct_dayrow{display:flex}" +
      ".dsct_pin:hover{color:rgba(0,0,0,.85)}" +
      ".dsct_pin[data-on='1']{color:var(--dsw-alias-state-business-primary,#4d6bfe)}" +
      "body[data-ds-dark-theme] .dsct_pin,[data-theme='dark'] .dsct_pin,.dark .dsct_pin{color:rgba(255,255,255,.4)}" +
      "body[data-ds-dark-theme] .dsct_pin:hover,[data-theme='dark'] .dsct_pin:hover,.dark .dsct_pin:hover{color:rgba(255,255,255,.85)}" +
".dsct_star:hover{color:rgba(0,0,0,.85)}" + 
".dsct_star.dsct_star_on{color:#d97706;opacity:1}" + 
"body[data-ds-dark-theme] .dsct_star:hover,[data-theme='dark'] .dsct_star:hover,.dark .dsct_star:hover{color:rgba(255,255,255,.85)}" + 
"body[data-ds-dark-theme] .dsct_star.dsct_star_on,[data-theme='dark'] .dsct_star.dsct_star_on,.dark .dsct_star.dsct_star_on{color:#fbbf24;opacity:1}" + 
      ".dsct_markbtn{-webkit-appearance:none;appearance:none;margin:0;padding:2px 8px;background:transparent;border:none;outline:none;box-shadow:none;font:inherit;font-size:12.5px;line-height:18px;color:rgba(0,0,0,.55);cursor:pointer;display:inline-flex;align-items:center;gap:3px}" +
      ".dsct_markbtn:hover{color:rgba(0,0,0,.85)}" +
      ".dsct_markbtn.dsct_markbtn_on{color:#d97706;font-weight:600}" +
      "body[data-ds-dark-theme] .dsct_markbtn,[data-theme='dark'] .dsct_markbtn,.dark .dsct_markbtn{color:rgba(255,255,255,.55)}" +
      "body[data-ds-dark-theme] .dsct_markbtn:hover,[data-theme='dark'] .dsct_markbtn:hover,.dark .dsct_markbtn:hover{color:rgba(255,255,255,.85)}" +
      "body[data-ds-dark-theme] .dsct_markbtn.dsct_markbtn_on,[data-theme='dark'] .dsct_markbtn.dsct_markbtn_on,.dark .dsct_markbtn.dsct_markbtn_on{color:#fbbf24;font-weight:600}" +
      ".dsct_dayrow{display:none;align-items:center;gap:6px;width:100%;margin:6px 8px 4px 0;flex-shrink:0;user-select:none}" +
      ".dsct_dayrow::before{content:'';flex:1;height:1px;background:rgba(0,0,0,.12)}" +
      ".dsct_dayrow span{font-size:10px;line-height:14px;color:rgba(0,0,0,.4);flex-shrink:0}" +
      "body[data-ds-dark-theme] .dsct_dayrow::before,[data-theme='dark'] .dsct_dayrow::before,.dark .dsct_dayrow::before{background:rgba(255,255,255,.14)}" +
      "body[data-ds-dark-theme] .dsct_dayrow span,[data-theme='dark'] .dsct_dayrow span,.dark .dsct_dayrow span{color:rgba(255,255,255,.4)}" +
      ".dsct_hover_t{font-size:11px;line-height:16px;color:rgba(0,0,0,.42);margin-bottom:4px}" +
      "body[data-ds-dark-theme] .dsct_hover_t,[data-theme='dark'] .dsct_hover_t,.dark .dsct_hover_t{color:rgba(255,255,255,.42)}" +
      ".dsct_hover{position:fixed;z-index:9999;width:340px;box-sizing:border-box;padding:10px 12px;border-radius:10px;background:rgba(255,255,255,.97);border:1px solid rgba(0,0,0,.08);box-shadow:0 10px 30px rgba(0,0,0,.12),0 2px 8px rgba(0,0,0,.06);pointer-events:none;opacity:0;transform:translateY(2px);transition:opacity .12s ease,transform .12s ease}" +
      ".dsct_hover.dsct_show{opacity:1;transform:translateY(0)}" +
      ".dsct_hover_q{font-size:13px;line-height:20px;font-weight:500;color:rgba(0,0,0,.85);white-space:pre-wrap;word-break:break-word;max-height:60px;overflow:hidden}" +
      ".dsct_hover_a{font-size:12px;line-height:19px;color:rgba(0,0,0,.55);white-space:pre-wrap;word-break:break-word;max-height:110px;overflow:hidden;margin-top:6px}" +
      ".dsct_hover_sep{height:1px;background:rgba(0,0,0,.07);margin:8px 0}" +
      "body[data-ds-dark-theme] .dsct_hover,[data-theme='dark'] .dsct_hover,.dark .dsct_hover{background:rgba(28,28,32,.97);border:1px solid rgba(255,255,255,.08);box-shadow:0 10px 30px rgba(0,0,0,.5),0 2px 8px rgba(0,0,0,.3)}" +
      "body[data-ds-dark-theme] .dsct_hover_q,[data-theme='dark'] .dsct_hover_q,.dark .dsct_hover_q{color:rgba(255,255,255,.88)}" +
      "body[data-ds-dark-theme] .dsct_hover_a,[data-theme='dark'] .dsct_hover_a,.dark .dsct_hover_a{color:rgba(255,255,255,.55)}" +
      "body[data-ds-dark-theme] .dsct_hover_sep,[data-theme='dark'] .dsct_hover_sep,.dark .dsct_hover_sep{background:rgba(255,255,255,.08)}" +
      ...
      /* 重点标记星星按钮 */
      ".dsct_star{font-size:13px;line-height:16px;width:18px;height:18px;display:inline-flex;align-items:center;justify-content:center;opacity:0;cursor:pointer;transition:all .15s ease;margin-right:6px;flex-shrink:0;color:rgba(0,0,0,.55);border-radius:4px}" +
      ...
      "body[data-ds-dark-theme] .dsct_star,[data-theme='dark'] .dsct_star,.dark .dsct_star{color:rgba(255,255,255,.55)}" +
      ...
      "@media (prefers-reduced-motion:reduce){.dsct_nav,.dsct_wrap,.dsct_title,.dsct_line,.dsct_star,.dsct_markbtn{transition:none}}";
    ...
    const styles = {
      ...
      wrapShow: "dsct_show",
      pin: "dsct_pin",
      hoverCard: "dsct_hover",
      hoverShow: "dsct_show",
      hoverQ: "dsct_hover_q",
      hoverA: "dsct_hover_a",
      hoverSep: "dsct_hover_sep",
      dayrow: "dsct_dayrow",
      hoverT: "dsct_hover_t",
      filter: "dsct_filter",
      filterBtn: "dsct_markbtn",
      filterOn: "dsct_markbtn_on",
      page: "dsct_page",
      empty: "dsct_empty",
      item: "dsct_item",
      ...
      line: "dsct_line"
        ...
        const IconPin = ({ filled = false, size = 14 }) => (0, react_jsx_runtime.jsx)("svg", {
      width: size, height: size, viewBox: "0 0 16 16", fill: "none", 'aria-hidden': true, style: { display: "block" },
      children: (0, react_jsx_runtime.jsx)("path", {
        d: "M9.5 1.5 14.5 6.5 12.7 8.3 12.2 7.8 9.2 10.8 9.5 12.5 8 14 5.5 11.5 2.5 14.5 1.5 13.5 4.5 10.5 2 9 3.5 7.5 5.2 7.8 8.2 4.8 7.7 4.3Z",
...
//#endregion
    ...
    function normalize(m) {
      ...
      return {
        ...
        ...(typeof m.reply === "string" ? { reply: m.reply } : {}),
    ...
    function collectFromNodes(snapshot) {
      ...
      const ordered = [...snapshot.chat.nodes.values()]
        .filter((node) => node !== null && typeof node === "object")
        .sort((a, b) => (a.anchorSeq ?? 0) - (b.anchorSeq ?? 0));
      for (const node of ordered) {
        ...
        let reply = "";
        for (let i = ordered.indexOf(node) + 1; i < ordered.length; i += 1) {
          const n2 = ordered[i];
          if (n2.kind === "user") break;
          if (n2.kind === "assistant" && n2.data !== null && typeof n2.data === "object" && Array.isArray(n2.data.content)) {
            for (const block of n2.data.content) {
              if (block !== null && typeof block === "object" && block.type === "text" && typeof block.text === "string") reply += block.text;
            }
          }
        }
        out.push({ seq: node.anchorSeq, time: data.time, text: userTextOf(data.content), reply: reply.trim().slice(0, 80), key });
      }
    ...
    function TimelineRail({ useProjection, sessionId, sessionsService, t }) {
      ...
      const [pinned, setPinned] = react.useState(() => {
        try { return localStorage.getItem("dsct_pinned_" + (sessionId ?? "'")) === "1"; } catch { return false; }
      });
      ...
      const togglePinned = () => {
        setPinned((prev) => {
          const next = !prev;
          try { localStorage.setItem("dsct_pinned_" + (sessionId ?? "'"), next ? "1" : "0"); } catch {}
          if (next) setShow(true);
          return next;
        });
      };
      react.useEffect(() => { if (pinned) setShow(true); }, [pinned]);
    ...
    const hoverCard = hoverMsg === null ? null : react_dom.createPortal(
      (0, react_jsx_runtime.jsxs)("div", {
        className: styles.hoverCard + " " + styles.hoverShow,
        style: { left: Math.max(8, hoverPos.x - 352) + "px", top: Math.max(8, Math.min(hoverPos.y - 40, (typeof window !== "undefined" ? window.innerHeight : 0) - 160)) + "px" },
        children: [
          hoverMsg.time > 0 && (0, react_jsx_runtime.jsx)("div", { className: styles.hoverT, children: (() => { const d = new Date(hoverMsg.time); const pad = (n) => (n < 10 ? "0" : "") + n; return d.getFullYear() + "-" + pad(d.getMonth() + 1) + "-" + pad(d.getDate()) + " " + pad(d.getHours()) + ":" + pad(d.getMinutes()); })() }),
          (0, react_jsx_runtime.jsx)("div", { className: styles.hoverQ, children: hoverMsg.text === "" ? "（无文本）" : hoverMsg.text }),
          (0, react_jsx_runtime.jsx)("div", { className: styles.hoverSep }),
          (0, react_jsx_runtime.jsx)("div", { className: styles.hoverA, children: hoverMsg.reply !== undefined && hoverMsg.reply !== "" ? hoverMsg.reply : "（该轮无文本回答）" })
        ]
      }),
      document.body
    );
          return react.createElement(react.Fragment, null, hoverCard, react_dom.createPortal(
        (0, react_jsx_runtime.jsxs)("div", {
                ...
                (0, react_jsx_runtime.jsx)("div", {
                  ...
                  children: [
                    (0, react_jsx_runtime.jsx)("span", {
                      ...
                      tabIndex: 0,
                      'aria-pressed': pinned,
                      'data-on': pinned ? "1" : void 0,
                      onClick: togglePinned,
                      onKeyDown: (e) => { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); togglePinned(); } },
                      children: (0, react_jsx_runtime.jsx)(IconPin, { filled: pinned })
                    }),
                ...
                (0, react_jsx_runtime.jsx)("div", {
                  ...
                  children: displayMessages.length === 0
                    ...
                    : displayMessages.map((m, idx) => {
                        const dayLabel = (() => {
                          if (m.time <= 0) return null;
                          const d = new Date(m.time);
                          const prev = idx > 0 ? displayMessages[idx - 1] : null;
                          if (prev !== null && prev.time > 0) {
                            const pd = new Date(prev.time);
                            if (pd.getFullYear() === d.getFullYear() && pd.getMonth() === d.getMonth() && pd.getDate() === d.getDate()) return null;
                          }
                          const now = new Date();
                        ...
                        return (0, react_jsx_runtime.jsxs)(react.Fragment, { key: key ?? String(m.seq), children: [
                        dayLabel !== null && (0, react_jsx_runtime.jsx)("div", { className: styles.dayrow, children: (0, react_jsx_runtime.jsx)("span", { children: dayLabel }) }),
                        (0, react_jsx_runtime.jsxs)("button", {
                          ...
                          onMouseEnter: (e) => {
                            ...
                            hoverTimer.current = setTimeout(() => setHoverMsg(m), 350);
                          },
                          onMouseLeave: () => {
                            if (hoverTimer.current) clearTimeout(hoverTimer.current);
                            hoverTimer.current = setTimeout(() => setHoverMsg(null), 80);
                          },
